      ...
      <div className="container hero-container">
        ...
        <div className="hero-brand">
          ...
          <h1 className="hero-title">
           ...
           <span className="hero-title-parentheses">
  ( )
</span>
        ...
        <p className="hero-description">
          A 36-hour national-level cybersecurity hackathon
          organized by SVVV and SVIT, Indore — the eighth edition,
          built in collaboration with the Indore Police
          Commissionerate.
        </p>
